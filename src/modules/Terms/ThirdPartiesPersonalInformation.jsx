...
export default function ThirdPartiesPersonalInformation() {
  return (
    <>
      <div className="w-full flex flex-col items-center my-[91px]">
        ...
        <div className="mt-[71px] max-w-[515px] border border-[#EAEAF4] p-[70px] w-full flex flex-col gap-6">
          <p className="text-[13px] text-[#A3A5B8]">
            핸디트립 구독 서비스 내 이용자 식별, 회원관리 및 서비스 제공,
            회원비교식별을 위해 회원번호와 함께 abc@naver.com 님의 개인정보를
            제공합니다. 해당 정보는 동의 철회나 서비스 탈퇴 시 또는 제공 목적
            달성 시 지체없이 파기됩니다. 아래 동의를 거부할 권리가 있으며,
          ...
          <p className="text-[13px] text-[#A3A5B8]">
            [필수 제공 항목]
            <br />
            카카오계정(이메일), 휴대전화 번호, 성별, CI(연계정보), 출생 연도,
            이름
          </p>
